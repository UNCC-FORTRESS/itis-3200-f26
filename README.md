...
Welcome! This repo has everything you need for the labs in *Introduction to Information Security & Privacy* (UNC Charlotte, Dr. Jian Xiang) — the undergraduate ITIS 3200 section. If you're in the graduate ITIS 6200/8200 section, you want [UNCC-FORTRESS/itis-6200-f26](https://github.com/UNCC-FORTRESS/itis-6200-f26) instead.
...
Browser-based lab tools are hosted live via GitHub Pages at `https://uncc-fortress.github.io/itis-3200-f26/` — every lab links directly to the tool(s) it needs, so you shouldn't have to go looking for these yourself.
